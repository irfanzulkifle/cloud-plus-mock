...
,
 ...
 },
 {
  ...
  "domainName": "Cloud Architecture",
  "explanations": {
   "A": "Note: this question references a network configuration diagram that wasn't preserved in the source material, so this option's fit can't be independently re-verified beyond the stated answer key.",
 ...
 },
 {
  ...
  "explanations": {
   ...
   "C": "172.16.12.18 is still within the 172.16.12.0/24 network as Server 1, so it does not isolate Server 2 — the servers remain reachable on the same subnet.",
   "D": "172.16.14.14 places Server 2 on a different subnet (172.16.14.0/24) entirely, which is what actually prevents the two servers from reaching each other on the same network."
  }
 },
 {
  "number": 79,
